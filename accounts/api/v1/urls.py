...
urlpatterns = [
    ...
    path(
        ...
        AuthenticatedUserInformation.as_view(),
        name="AuthenticatedUserInformation_API",
    ),
    # user showing and edit account
    path(
        "user/<int:pk>",
        UserInformationShowing.as_view(),
        name="UserInformationShowing_API",
    ),
    path(
        "user/<int:pk>/change-password",
        UserChangePassWord.as_view(),
        name="UserChangePassWord_API",
    ),
    path(
        "user/<int:pk>/change-email",
        UserChangeEmail.as_view(),
        name="UserChangeEmail_API",
    ),
    path(
        "user/<int:pk>/update-profile",
        UserChangeProfile.as_view(),
        name="UserChangeProfile_API",
    ),
    # token authentications urls
    path(
        "token/login/",
        CustomAuthenticationsToken.as_view(),
        name="CustomAuthenticationsToken_API",
    ),
    ...
    path(
        ...
        name="CustomTokenObtainPairView_API",
    ),
